...
def upgrade() -> None:
    ...
    op.execute("CREATE SCHEMA IF NOT EXISTS dataset")  # added by fossilfriend
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_metadata_track_track_id"), table_name="track", schema="dataset"
    )
    op.drop_index(
        "ix_metadata_track_shard_root_track_id",
        table_name="track",
    ...
    op.drop_index(
        op.f("ix_metadata_track_genome_build"), table_name="track", schema="dataset"
    )
    op.drop_index(
        op.f("ix_metadata_track_feature_type"), table_name="track", schema="dataset"
    )
    op.drop_index(
        op.f("ix_metadata_track_data_store"), table_name="track", schema="dataset"
    )
