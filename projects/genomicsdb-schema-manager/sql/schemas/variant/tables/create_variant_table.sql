...
CREATE TYPE TYPE_ARIANT_CLASS AS ENUM (
    'SNV',
    'MNV',
    'SHORT_INDEL',
    'SHORT_DEL',
...
CREATE TABLE Variant.Variant (
    ...
    VARIANT_CLASS TYPE_VARIANT_CLASS NOT NULL,
    ...
    FOREIGN KEY (EXTERNAL_DATABASE_RELEASE_ID) REFERENCES Reference.ExternalDatabase(EXTERNAL_DATABASE_RELEASE_ID)
