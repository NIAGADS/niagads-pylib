...
- **Invalid error aggregation**: Resolution of a crash in niagads.metadata_validator caused by an invalid .append() call on the errors dictionary. Fixes validation failures triggered by duplicate biosource IDs or invalid sample references.
