...
from niagads.api.common.models.features.gene import (
...
from niagads.api.common.parameters.record.path import gene_param
...
from niagads.api.genomicsdb.queries.records.gene import (
...
@router.get(
    "/{gene}/pathways",
    response_model=Union[GeneAnnotationResponse, BaseResponseModel, TableViewResponse],
...
async def get_gene_pathways(
    ...
    internal: InternalRequestParameters = Depends(),
) -> Union[GeneAnnotationResponse, BaseResponseModel, TableViewResponse]:
    ...
    helper = GenomicsRouteHelper(
        ...
        ResponseConfiguration(
            ...
            format=response_format,
            view=response_view,
            model=BaseResponseModel if counts_only else GeneAnnotationResponse,
        ),
        Parameters(id=gene.feature_id),
...
@router.get(
    ...
    response_model=Union[
        GeneticAssociationResponse, BaseResponseModel, TableViewResponse
    ],
...
async def get_gene_genetic_associations(
    ...
    internal: InternalRequestParameters = Depends(),
) -> Union[GeneticAssociationResponse, BaseResponseModel, TableViewResponse]:
    ...
    helper = GenomicsRouteHelper(
        ...
        ResponseConfiguration(
            ...
            format=response_format,
            view=response_view,
            model=BaseResponseModel if counts_only else GeneticAssociationResponse,
        ),
        Parameters(
            id=gene.feature_id,
